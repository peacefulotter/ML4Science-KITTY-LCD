...
def find_descriptors_correspondence(point_descriptors, patch_descriptors):
    ...
    dist, corresponding_indexes = index.search(point_descriptors, k) #search for k nearest neighbours
    return corresponding_indexes.reshape((-1, )) # corresponding images(nb img neighbours) = arr of indexes inside arr_point_descriptors
